...
const DynamicHero = () => {
  ...
  return (
    <section 
      ref={containerRef}
      id="home" 
      className="relative h-screen flex flex-col items-center justify-center overflow-hidden pt-16"
    >
      ...
      >
        ...
        >
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-black tracking-[0.1em] mb-1">
            <span className="text-foreground">ORIGIN</span>
          </h1>
          <motion.p 
            className="text-base md:text-xl font-sans tracking-[0.3em] text-foreground/60"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        {/* Tagline */}
        <motion.p
          className="text-xs md:text-sm font-sans text-foreground/50 max-w-md mx-auto mb-4 leading-relaxed"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <motion.a 
            href="#register" 
            className="group relative px-8 py-3 font-sans text-sm font-bold bg-foreground text-background rounded-lg overflow-hidden"
          ...
          <motion.a 
            href="#about" 
            className="group px-8 py-3 font-sans text-sm font-bold border border-foreground/20 text-foreground rounded-lg backdrop-blur-md"
            whileHover={{ 
