...
const supportingCrew = [
  ...
  },
  {
    name: "Bhuvanesh H",
    role: "Tech Lead",
    image: "https://res.cloudinary.com/duoigqhsw/image/upload/v1770445793/Bhuvanesh_jx3h0t.jpg",
  ...
  },
  {
    ...
    linkedin: "https://www.linkedin.com/in/monika-ethiraj-a905a03ab/",
    ...
    <section id="team" className="relative py-32 overflow-hidden bg-background">
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto [&>*]:w-[calc(50%-0.5rem)] [&>*]:sm:w-[calc(25%-0.75rem)]">
